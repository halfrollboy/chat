...
class ExamplePublisher(object):
    ...
    def on_channel_returned(self, channel, method, properties, body):
        ...
        LOGGER.warning(
            "Channel = {} returned, method = {}, properties = {}, body = {}".format(
    ...
    def on_delivery_confirmation(self, method_frame):
        ...
        //Вроде как удаляет сообщения которые уже исполнились
        """
...
def main():
    ...
    example = ExamplePublisher(
        ...
        + ":"
        + password
        + "@localhost:5672/%2F?connection_attempts=3&heartbeat=3600"
    )
    example.run()
